...
export const ALL_PERMISSIONS: { id: AppPermission; label: string; description: string }[] = [
  ...
  { id: 'purchase', label: 'Purchase (Semua Modul)', description: 'Akses penuh modul Purchase (Purchase Request, Purchase Order, dan Purchase Invoice)' },
  ...
  { id: 'purchaseInvoice', label: 'Purchase Invoice', description: 'Pencatatan invoice supplier atas penerimaan barang (Delivery Order) berdasarkan PO' },
