...
export const ROLE_PRESETS: Record<UserRole, { label: string; permissions: AppPermission[]; description: string }> = {
  ...
  finance: {
    ...
    description: 'Mengelola perencanaan budget, realisasi pengeluaran, purchase, sales, fixed asset, inventory, master data, kurs, dan informasi perusahaan',
    permissions: [
      'budget',
      'dashboard',
      'planner',
  ...
  dept_user: {
    ...
    description: 'Melihat planning departemen, purchase request, sales, fixed asset, inventory, master data, mencatat penggunaan budget, dan summary budget',
    permissions: [
      'budget',
      'dashboard',
      'deptPlanning',
